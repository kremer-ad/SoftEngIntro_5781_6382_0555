...
public class FastRenderer extends AntialiasingRenderer {
     ...
     * @return the Render object itself
     */
    public FastRenderer setDebugPrint() {
    ...
    private class Pixel {
        ...
        private synchronized int nextP(Pixel target) {
            ...
            if (col < this.maxCols) {
                target.row = this.row;
                target.col = this.col;
                if (FastRenderer.this.print && this.counter == this.nextCounter) {
                    ++this.percents;
        ...
        public boolean nextPixel(Pixel target) {
            ...
            if (FastRenderer.this.print && percent > 0)
                synchronized (this) {
                    notifyAll();
                }
            if (percent >= 0)
