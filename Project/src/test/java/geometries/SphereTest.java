...
public class SphereTest {
    ...
    public void testFindIntersections() {
        ...
        assertEquals("Ray start's inside and crosses sphere",
                List.of(new Point3D(2d,0,0)), result);

        // TC04: Ray starts after the sphere (0 points)
        result = sphere.findIntersections(new Ray(new Point3D(2.1d, 0, 0),
                new Vector(1d, 1d, 0)));
        ...
        result = sphere.findIntersections(new Ray(new Point3D(1d,-1d,0), new Vector(1d, 1d, 0)));
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Ray start's at sphere and goes inside",
                List.of(new Point3D(2d, 0, 0)), result);

        // TC12: Ray starts at sphere and goes outside (0 points)
        result = sphere.findIntersections(new Ray(new Point3D(2d, 0, 0),
                new Vector(1d, 1d, 0)));
        ...
        result = sphere.findIntersections(new Ray(new Point3D(1d, -2d, 0),
                new Vector(0, 1d, 0)));
        assertEquals("Wrong number of points", 2, result.size());
        if (result.get(0).getX() > result.get(1).getX())
            result = List.of(result.get(1), result.get(0));
        assertEquals("Ray crosses sphere (through center)",
                List.of(new Point3D(1d,-1d,0), new Point3D(1d,1d,0)), result);

        // TC14: Ray starts at sphere and goes inside (1 points)
        result = sphere.findIntersections(new Ray(new Point3D(1d,-1d,0), new Vector(0, 1d, 0)));
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Ray start's at sphere and goes inside (through center)",
                List.of(new Point3D(1d, 1d, 0)), result);

        // TC15: Ray starts inside (1 points)
        result = sphere.findIntersections(new Ray(new Point3D(0.5d,0,0), new Vector(1d, 0, 0)));
        assertEquals("Wrong number of points", 1, result.size());
        assertEquals("Ray start's inside sphere (through center)",
                List.of(new Point3D(2d, 0, 0)), result);

        // TC16: Ray starts at the center (1 points)
        result = sphere.findIntersections(new Ray(new Point3D(1d,0,0), new Vector(1d, 0, 0)));
        assertEquals("Wrong number of points", 1, result.size());
        ...
        result = sphere.findIntersections(new Ray(new Point3D(3d,0,0), new Vector(1d, 0, 0)));
        ...
        result = sphere.findIntersections(new Ray(new Point3D(0,1d,0), new Vector(1d, 0, 0)));
        assertNull("Ray starts before the tangent point", result);

        // TC20: Ray starts at the tangent point
        result = sphere.findIntersections(new Ray(new Point3D(1d,1d,0), new Vector(1d, 0, 0)));
        assertNull("Ray starts at the tangent point", result);

        // TC21: Ray starts after the tangent point
        result = sphere.findIntersections(new Ray(new Point3D(3d,1d,0), new Vector(1d, 0, 0)));
        ...
        result = sphere.findIntersections(new Ray(new Point3D(3d,0,0), new Vector(0, 1d, 0)));
